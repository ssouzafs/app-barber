...
@section('title', 'Detalhes de Marca')
@section('content')
    <div class="main_container">
        <div class="main_container_content">
            <header class="d-flex justify-content-between align-items-center">
                <h1 class="icon-file-text-o">Detalhes da Marca #{{ $brand->id ?? ''}}</h1>
            ...
            @if ($brand)
                <form class="row g-3" id="page_single">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="description" value="{{ $brand->description }}">
                    </div>
                    <div class="col-md-12">
                        <label for="id" class="form-label">Categoria:</label>
                        <input type="text" class="form-control" id="id"
                               value="#{{ $brand->category->id }} - {{ $brand->category->description }}">
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <input type="text" class="form-control" id="created_by"
                               value="{{ get_created_by($brand->created_by)}}">
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="updated_by"
                               value="{{ !empty($brand->updated_by) ? get_updated_by($brand->updated_by) : get_created_by($brand->created_by) }}">
                    </div>
