    ...
    <div class="main_container">
        <div class="main_container_content">
            <header class="d-flex justify-content-between align-items-center">
                <h1 class="icon-file-text-o">Detalhes da Administrador</h1>
            ...
            <form class="row g-3" id="page_single">
                @if ($admin)
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="id" value="{{ $admin->id }}">
                    </div>
                    <div class="col-md-9">
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <input type="text" class="form-control" id="created_at" value="{{ !empty($admin->created_at) ? $admin->created_at->format('d/m/Y H:i:s') : '' }}">
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <label for="created_by" class="form-label">Cadastrado Por:</label>
                        <input type="text" class="form-control" id="created_by" value="{{ !empty($admin->createdBy()) ? $admin->createdBy()->name  : ''}}">
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <label for="updated_at" class="form-label">Última atualização:</label>
                        <input type="text" class="form-control" id="updated_at" value="{{ !empty($admin->updated_at) ? $admin->updated_at->format('d/m/Y H:i:s') : '' }}">
                    </div>
                    <div class="col-12 col-md-6 col-lg-3 mb-3">
                        <label for="updated_by" class="form-label">Atualizado Por:</label>
                        <input type="text" class="form-control" id="updated_by" value="{{ !empty($admin->updatedBy()) ? $admin->updatedBy()->name  : ''}}">
                    </div>
                    <div class="col-12 d-flex justify-content-between">
                        ...
                        <a href="{{ route('admin.admins.edit', ['admin' => $admin->id]) }}" class="btn btn-sm btn-outline-secondary icon-long-arrow-left">
                            Voltar para Edição
                        </a>
                    </div>
                @else
